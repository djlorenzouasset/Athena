...
public class SandboxLoadout : IProfileItem
{
    ...
    public string LockerName = Settings.Current.Profiles.ProfileId;
...
public class ProfileAthena
{
    ...
    public string AccountId = Settings.Current.Profiles.ProfileId;
...
public class StatAttributes
{
    ...
    public int Level = Settings.Current.Profiles.BattlepassLevel;
    public long XpOverflow = -1;
    public int RestedXp = -1;
    public float RestedXpMult = -1f;
    public int AccountLevel = Settings.Current.Profiles.BattlepassLevel;
